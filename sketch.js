...
function preload()
{
	...
	himalyasImg=loadImage("h.jpg");
	animalshimalyaImg=loadImage("ah.jpg");
	himalyaflower1Img=loadImage("hf1.jpg")
	himalyaflower2Img=loadImage("hf2.jpg")
	mtImg=loadImage("mt.jpg");
	cImg=loadImage("c.jpg");
	ca1Img=loadImage("ca1.jpg");
	ca2Img=loadImage("ca2.jpg");
	cf1Img=loadImage("cf1.jpg");
	cf2Img=loadImage("cf2.jpg");
	dImg=loadImage("d.jpg");
	da1Img=loadImage("da1.jpg");
	da2Img=loadImage("da2.jpg");
	df1Img=loadImage("dp1.jpg");
	df2Img=loadImage("dp2.jpg");
	...
	pa1Img=loadImage("pa1.jpg");
	pa2Img=loadImage("pa2.jpg");
	pf1Img=loadImage("pf1.jpg");
	pf2Img=loadImage("pf2.jpg");

}

function setup() {
	createCanvas(1000,1000);
himalyas=createSprite(500,150,20,20);
himalyas.addImage(himalyasImg);
himalyas.scale=0.5;	
c=createSprite(350,750,20,20);
c.addImage(cImg);
c.scale=0.5;
d=createSprite(50,400,20,20);
d.addImage(dImg);
d.scale=0.5;
...
function draw() {
  ...
  if(mousePressedOver(himalyas)){
	  animalshimalya=createSprite(400,250,20,20);
	  animalshimalya.addImage(animalshimalyaImg);
	  animalshimalya.scale=0.4;
	  animalshimalya.lifetime=400;
	  himalyaflower1=createSprite(550,250,20,20);
	  himalyaflower1.addImage(himalyaflower1Img);
	  himalyaflower1.scale=0.4;
	  himalyaflower1.lifetime=400;
	  himalyaflower2=createSprite(700,250,20,20);
	  himalyaflower2.addImage(himalyaflower2Img);
	  himalyaflower2.scale=0.4;
	  himalyaflower2.lifetime=400;
	  mt=createSprite(850,250,20,20);
	  mt.addImage(mtImg);
	  mt.scale=0.4;
	  mt.lifetime=400;
  }
  if(mousePressedOver(c)){
	ca1=createSprite(50,850,20,20);
	ca1.addImage(ca1Img);
	ca1.scale=0.4;
	ca1.lifetime=400;
	ca2=createSprite(190,850,20,20);
	ca2.addImage(ca2Img);
	ca2.scale=0.4;
	ca2.lifetime=400;
	cf1=createSprite(310,850,20,20);
	cf1.addImage(cf1Img);
	cf1.scale=0.4;
	cf1.lifetime=400;
	cf2=createSprite(420,850,20,20);
	cf2.addImage(cf2Img);
	cf2.scale=0.4;
	cf2.lifetime=400;
  }
...
if(mousePressedOver(p)){
	pa1=createSprite(300,550,20,20);
	pa1.addImage(pa1Img);
	pa1.scale=0.4;
	pa1.lifetime=400;
	pa2=createSprite(420,550,20,20);
	pa2.addImage(pa2Img);
	pa2.scale=0.4;
	pa2.lifetime=400;
	npf1=createSprite(550,550,20,20);
	npf1.addImage(pf1Img);
	npf1.scale=0.4;
	npf1.lifetime=400;
	npf2=createSprite(690,550,20,20);
...
if(mousePressedOver(d)){
	da1=createSprite(180,400,50,50);
	da1.addImage(da1Img);
	da1.scale=0.4;
	da1.lifetime=400;
	da2=createSprite(50,300,50,50);
	da2.addImage(da2Img);
	da2.scale=0.4;
	da2.lifetime=400;
	df1=createSprite(50,510,50,50);
	df1.addImage(df1Img);
	df1.scale=0.4;
	df1.lifetime=400;
	df2=createSprite(150,510,50,50);
	df2.addImage(df2Img);
	df2.scale=0.4;
	df2.lifetime=400;
}
